...
#define DUFFS_LOOP4(pixel_copy_increment, width)        \
    {                                                   \
        ...
        case 0:                                         \
            do                                          \
            {                                           \
                pixel_copy_increment; /* fallthrough */ \
            case 3:                                     \
                pixel_copy_increment; /* fallthrough */ \
            case 2:                                     \
                pixel_copy_increment; /* fallthrough */ \
...
#define BUILD_RENDER_LINE(NAME, IS_BLENDED, IS_BLENDED_OPAQUE, IS_LCD, WB_WP_WC, WS, BLIT_GLYPH_BLENDED_OPAQUE_OPTIM, BLIT_GLYPH_BLENDED_OPTIM, BLIT_GLYPH_OPTIM) \
                                                                                                                                                                  \
    static SDL_INLINE int Render_Line_##NAME(TTF_Font *font, SDL_Surface *textbuf, int xstart, int ystart, SDL_Color *fg)                                         \
    {                                                                                                                                                             \
...
static FT_Error Load_Glyph(TTF_Font *font, c_glyph *cached, int want, int translation)
{
        ...
        (want & CACHED_SUBPIX))
    {
        ...
        /* Render as outline */
        if ((font->outline_val > 0 && slot->format == FT_GLYPH_FORMAT_OUTLINE) || slot->format == FT_GLYPH_FORMAT_BITMAP)
        {
